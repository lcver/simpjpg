...
<head>
    ...
    <title>E-Building | Daftar Pengguna</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li class="active">
                        <h4>Daftar Pengguna Kementerian Kesehatan</h4>
                    </li>
                </ol>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($penggunaList as $data)
                                    <tr>
                                        <td>{{ ($penggunaList->currentPage() - 1) * $penggunaList->perPage() + $loop->iteration }}</td>
                                        <td>{{ $data->name }}</td>
                                        <td>{{ $data->email }}</td>
                                        <td>{{ $data->role->name }}</td>
                                        <td>
                                            <a href="{{ route('pengguna.edit', ['id' => $data->id]) }}"class="btn btn-warning">EDIT</a>
                                            <a href="{{ route('pengguna.destroy', ['id' => $data->id]) }}" onclick="return confirm('Ingin menghapus <?= $data->penyedia ?>?')" class="btn btn-danger">DELETE</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
