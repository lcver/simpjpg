...
<head>
    ...
    <title>E-Building | Daftar Penyedia</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="my-5 d-flex justify-content-between">
                    <a href="{{ route('penyedia.create') }}"class="btn btn-primary">Tambah Data</a>
                    <a href="#"class="btn btn-info pull-right">Show Deleted Data</a>
                </div>
                </p>
                <ol class="breadcrumb">
                    <li class="active">
                        <h4>Daftar Penyedia Kementerian Kesehatan</h4>
                    </li>
                </ol>
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($penyediaList as $data)
                                <tr>
                                    <td>{{ ($penyediaList->currentPage() - 1) * $penyediaList->perPage() + $loop->iteration }}</td>
                                    <td>{{ $data->penyedia }}</td>
                                    <td>
                                        <a href="{{ route('penyedia.edit', ['id' => $data->id]) }}"class="btn btn-warning">EDIT</a>
                                        <a href="{{ route('penyedia.destroy', ['id' => $data->id]) }}" onclick="return confirm('Ingin menghapus <?= $data->penyedia ?>?')" class="btn btn-danger">DELETE</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
