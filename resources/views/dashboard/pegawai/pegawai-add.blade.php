    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li class="active">
                        <h4>Tambah Data Pegawai Kementerian Kesehatan</h4>
                    </li>
                </ol>
                    ...
                    <form action="{{ route('pegawai.store') }}" method="post">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="pegawai" class="form-control" name="pegawai" id="pegawai" placeholder="Masukkan Nama Pegawai" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="address" class="form-control" name="address" id="address" placeholder="Masukkan Alamat Rumah" required>
                            </div>
                            <div class="form-group">
                                <label for="handphone">Nomor Handphone Pegawai</label>
                                <input type="handphone" class="form-control" name="handphone" id="handphone" placeholder="Masukkan Nomor Handphone"required>
                            </div>
