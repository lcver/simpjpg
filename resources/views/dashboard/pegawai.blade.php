...
<head>
    ...
    <title>E-Building | Daftar Pegawai</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li class="active">
                        <h4>Daftar Pegawai Kementerian Kesehatan</h4>
                    </li>
                </ol>

                <div class="box box-info">
                    <div class="box-header">
                        <h3 class="box-title">Data Tabel Pegawai Kementerian Kesehatan</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Nama Pegawai Kementerian Kesehatan</th>
